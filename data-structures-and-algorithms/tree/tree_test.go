...
func Test2(t *testing.T) {
	...
	list := SystemMenus.ConvertToINodeArray(allMenu)
	fmt.Println("list: ", list)

	// [
	//{1 0 系统总览 /systemOverview icon-system}
	//{2 0 系统配置 /systemConfig icon-config}
	//{3 1 资产 /asset icon-asset}
	//{4 1 动环 /pe icon-pe}
	//{5 2 菜配置 /menuConfig icon-menu-config}
	//{6 3 设备 /device icon-device}
	//{7 3 机柜 /device icon-device}
	//]
